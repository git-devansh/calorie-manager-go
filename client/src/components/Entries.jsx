...
function Entries() {
  ...
  return (
    <div>
      <Container>
        <Button className="m-4" onClick={() => setAddNewEntry(true)}>
          Add new calories
        </Button>
      </Container>
      <Container>
      ...
      <Modal show={addNewEntry} onHide={() => setAddNewEntry(false)} centred>
        <Modal.Header closeButton>
          <Modal.Title>Add Calorie</Modal.Title>
        </Modal.Header>

        <Modal.Body>
          <Form.Group>
            <Form.Label>What did you had?</Form.Label>
            <Form.Control
              onChange={(event) => {
          ...
          <Button className="m-2" onClick={() => addSingleEntry()}>
            Add
          </Button>
          <Button className="m-2" onClick={() => setAddNewEntry(false)}>
            Cancel
          </Button>
        </Modal.Body>
      </Modal>
